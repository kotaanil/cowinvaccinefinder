...
//    using ConsoleApp4;
//
//    var responseDto = ResponseDto.FromJson(jsonString);
...
namespace ConsoleApp4
{
    ...
    public partial class ResponseDto
    {
        public static ResponseDto FromJson(string json) => JsonConvert.DeserializeObject<ResponseDto>(json, ConsoleApp4.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this ResponseDto self) => JsonConvert.SerializeObject(self, ConsoleApp4.Converter.Settings);
    }
