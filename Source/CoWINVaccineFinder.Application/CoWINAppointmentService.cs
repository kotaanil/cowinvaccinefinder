...
namespace CoWINVaccineFinder.Application
{
    public class CoWINAppointmentService
    {
        ...
        public async Task<ResponseDto> FetchSessionsByPinAndDate(string pincode,string date, CancellationToken cancellationToken)
        {
        ...
        public async Task<ResponseDto> FetchSessionsByDistrictIdAndDate(string districtId, string date, CancellationToken cancellationToken)
        {
            var queryString = new Dictionary<string, string>();
